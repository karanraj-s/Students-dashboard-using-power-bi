...
- **Course-Wise Revenue Analysis**
  - Bar chart displaying revenue contribution by each course  

- **Certificate Issuance Tracking**
  - Gauge chart showing issued certificates vs total students  

- **Monthly Enrollment Trend**
  - Column chart illustrating student enrollment by month  

- **Demographic Insights**
  - Donut chart representing student distribution by age group  
